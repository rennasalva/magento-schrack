...
class Customweb_Http_Url {
	...
	public function __construct($url) {
		if ($url instanceof Customweb_Http_Url) {
            ...
            //------------------------------------------------------------------
            Mage::log('The given "url" parameter must be either a string or a Customweb_Http_Url.', null, '/payment/payment-exception.log');
            //######################################### SCHRACK_CUSTOM ***END***
	...
	public function setUrlFromString($url) {
		...
		if (is_string($url)) {
            ...
            // doing extra logging -> Payment Exception
            //------------------------------------------------------------------
            Mage::log('Parameter $url is not string.', null, '/payment/payment-exception.log');
            //######################################### SCHRACK_CUSTOM ***END***
	...
	public function setPort($port) {
		if (!is_int($port)) {
            ...
            // doing extra logging -> Payment Exception
            //------------------------------------------------------------------
            Mage::log('The given port is not an integer.', null, '/payment/payment-exception.log');
            //######################################### SCHRACK_CUSTOM ***END***
	...
	public function setScheme($scheme) {
		if (!is_string($scheme)) {
            ...
            // doing extra logging -> Payment Exception
            //------------------------------------------------------------------
            Mage::log('The given scheme is not a string.', null, '/payment/payment-exception.log');
            //######################################### SCHRACK_CUSTOM ***END***
	...
	public function setHost($host) {
		if (!is_string($host)) {
            ...
            // doing extra logging -> Payment Exception
            //------------------------------------------------------------------
            Mage::log('The given host is not a string.', null, '/payment/payment-exception.log');
            //######################################### SCHRACK_CUSTOM ***END***
	...
	public function setUser($user) {
		if (!is_string($user)) {
            ...
            // doing extra logging -> Payment Exception
            //------------------------------------------------------------------
            Mage::log('The given username is not a string.', null, '/payment/payment-exception.log');
            //######################################### SCHRACK_CUSTOM ***END***
	...
	public function setPass($pass) {
		if (!is_string($pass)) {
            ...
            // doing extra logging -> Payment Exception
            //------------------------------------------------------------------
            Mage::log('The given password is not a string.', null, '/payment/payment-exception.log');
            //######################################### SCHRACK_CUSTOM ***END***
	...
	public function setPath($path) {
		if (!is_string($path)) {
            ...
            // doing extra logging -> Payment Exception
            //------------------------------------------------------------------
            Mage::log('The given path is not a string.', null, '/payment/payment-exception.log');
            //######################################### SCHRACK_CUSTOM ***END***
	...
	public function setQuery($query) {
		if (is_array($query)) {
            ...
            // doing extra logging -> Payment Exception
            //------------------------------------------------------------------
            Mage::log('The given parameter \'query\' must be either an array or a string. You give another type.', null, '/payment/payment-exception.log');
            //######################################### SCHRACK_CUSTOM ***END***
