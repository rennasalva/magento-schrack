...
var checkAvailability = function(ajaxUrl, sku, qty, drumId, pickup, delivery) {
...
var imagePreviewHover = function() {
    /* CONFIG */
    xOffset      = 60;
    yOffset      = 30;
    imageOpacity = 1;
...
var checkValidQuantity = function(url, sku, qty) {
    var result = "";
