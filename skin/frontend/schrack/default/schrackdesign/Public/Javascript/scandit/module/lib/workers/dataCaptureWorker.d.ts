 ...
 * @hidden
 */
export declare type DataCaptureSentMessageData = ["library-loaded"] | ["context-created", object] | ["work-result", {
    requestId: number;
    result: {
...
export declare type DataCapture = {
    loadLibrary(deviceId: string, libraryLocation: string, locationPath: string, preload: boolean, delayedRegistration: boolean, highEndBlurryRecognition: boolean, licenseKey?: string, deviceModelName?: string): Promise<void>;
