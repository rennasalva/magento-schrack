...
export function dataCapture() {
    ...
    function applyScanSettings(highQualitySingleFrameMode = false) {
        ...
        const resultPointer = Module._scanner_settings_new_from_json(scanSettingsPointer, parsedSettings.blurryRecognition && blurryRecognitionAvailable, parsedSettings.matrixScanEnabled ?? false, highQualitySingleFrameMode, gpuAccelerationAvailable && parsedSettings.gpuAcceleration);
