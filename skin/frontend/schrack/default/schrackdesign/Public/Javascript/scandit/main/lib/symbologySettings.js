...
var SymbologySettings = /** @class */ (function () {
    ...
    SymbologySettings.prototype.enableExtensions = function (extension) {
        ...
        if (typeof extension === "object") {
            this.extensions = new Set(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(this.extensions)), tslib_1.__read(Array.from(extension).filter(function (e) {
    ...
    SymbologySettings.prototype.disableExtensions = function (extension) {
        if (typeof extension === "object") {
            this.extensions = new Set(tslib_1.__spreadArray([], tslib_1.__read(this.extensions)).filter(function (x) {
    ...
    SymbologySettings.prototype.enableChecksums = function (checksum) {
        ...
        if (typeof checksum === "object") {
            this.checksums = new Set(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(this.checksums)), tslib_1.__read(Array.from(checksum).filter(function (c) {
    ...
    SymbologySettings.prototype.disableChecksums = function (checksum) {
        if (typeof checksum === "object") {
            this.checksums = new Set(tslib_1.__spreadArray([], tslib_1.__read(this.checksums)).filter(function (x) {
