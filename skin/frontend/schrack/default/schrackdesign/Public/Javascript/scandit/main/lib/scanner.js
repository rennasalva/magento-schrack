...
var Scanner = /** @class */ (function () {
    ...
    function Scanner(_a) {
        ...
        this.dataCaptureWorker = index_1.dataCaptureLoader.getDataCaptureWorker();
        this.dataCaptureWorker.onmessage = this.dataCaptureWorkerOnMessage.bind(this);
        dataCaptureLoader_1.DataCaptureLoader.load(this.dataCaptureWorker);
    ...
    Scanner.prototype.destroy = function () {
        if (this.dataCaptureWorker != null) {
            index_1.dataCaptureLoader.returnDataCaptureWorker(this.dataCaptureWorker);
        }
    ...
    Scanner.prototype.applyScanSettings = function (scanSettings) {
        ...
        if (this.blurryRecognitionAvailable) {
            this.activeBlurryRecognitionSymbologies = new Set(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(this.activeBlurryRecognitionSymbologies)), tslib_1.__read(activeBlurryRecognitionSymbologies)));
        }
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        ...
                        _this.eventEmitter.once(workErrorEvent, function (error, _) {
                            console.error("Scandit Data Capture error (" + error.errorCode + "):", error.errorMessage);
                        ...
                        _this.dataCaptureWorker.postMessage({
                            type: "scan-image",
    ...
    Scanner.prototype.handleBlurryTablesUpdate = function () {
        ...
        this.blurryRecognitionAvailable = index_1.blurryRecognitionPreloader.isBlurryRecognitionAvailable(this.scanSettings);
        if (this.blurryRecognitionAvailable) {
            this.activeBlurryRecognitionSymbologies = new Set(tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(this.activeBlurryRecognitionSymbologies)), tslib_1.__read(index_1.blurryRecognitionPreloader.getEnabledSymbologies(this.scanSettings))));
            this.dataCaptureWorker.postMessage({
                type: "scan-settings",
                settings: this.scanSettings.toJSONString(),
    ...
    Scanner.prototype.dataCaptureWorkerOnMessage = function (ev) {
        var data = ev.data;
