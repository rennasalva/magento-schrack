        ...
        openDbRequest.onsuccess = function () {
          try {
            ...
            storeKeysRequest.onsuccess = function () {
              ...
              if ((highEndBlurryRecognition ? BlurryRecognitionPreloader.highEndBlurryTableFiles : BlurryRecognitionPreloader.defaultBlurryTableFiles).every(function (file) {
...
_defineProperty(BlurryRecognitionPreloader, "availableBlurryRecognitionSymbologies", new set([Barcode.Symbology.EAN13, Barcode.Symbology.EAN8, Barcode.Symbology.CODE32, Barcode.Symbology.CODE39, Barcode.Symbology.CODE128, Barcode.Symbology.CODE93, Barcode.Symbology.INTERLEAVED_2_OF_5, Barcode.Symbology.MSI_PLESSEY, Barcode.Symbology.CODABAR, Barcode.Symbology.UPCA, Barcode.Symbology.UPCE // Shared with EAN8, EAN13, UPCA
]));
  ...
  _createClass(ScanSettings, [{
    ...
    value: function getSymbologySettings(symbology) {
      if (this.symbologySettings.has(symbology)) {
        ...
        if (symbology in Barcode.Symbology || values(Barcode.Symbology).includes(symbology)) {
    ...
    value: function setMultipleSymbologiesEnabled(symbology, enabled) {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          if (!(s in Barcode.Symbology || values(Barcode.Symbology).includes(s))) {
...
var Scanner = /*#__PURE__*/function () {
  ...
  _createClass(Scanner, [{
    ...
    value: function handleBlurryTablesUpdate() {
      ...
      if (this.blurryRecognitionAvailable) {
        this.activeBlurryRecognitionSymbologies = new set([].concat(_toConsumableArray(this.activeBlurryRecognitionSymbologies), _toConsumableArray(blurryRecognitionPreloader.getEnabledSymbologies(this.scanSettings))));
        this.dataCaptureWorker.postMessage({
          type: "scan-settings",
          settings: this.scanSettings.toJSONString(),
...
(function (CameraAccess) {
  ...
  function sortCamerasForCameraType(cameras, cameraType) {
    ...
    return cameraType === Camera.Type.FRONT ? [].concat(_toConsumableArray(frontCameras), _toConsumableArray(backCameras)) : [].concat(_toConsumableArray(backCameras), _toConsumableArray(frontCameras));
  }
...
var Validator = /*#__PURE__*/function () {
  ...
  _createClass(Validator, null, [{
    ...
    value: function isValidCameraType(value) {
      return values(Camera.Type).includes(value);
    }
  }, {
    key: "isValidGuiStyle",
    value: function isValidGuiStyle(value) {
      return values(BarcodePicker.GuiStyle).includes(value);
    }
  }, {
    key: "isValidVideoFit",
    value: function isValidVideoFit(value) {
      return values(BarcodePicker.ObjectFit).includes(value);
    }
  }, {
    key: "isValidCodeDirection",
    value: function isValidCodeDirection(value) {
      return values(ScanSettings.CodeDirection).includes(value);
    }
  }, {
    key: "isArray",
    ...
    value: function getExpectationMessageForType(type) {
      var messageByType = {
        ...
        videoFit: "Expected one of \"".concat(values(BarcodePicker.ObjectFit).join('", "'), "\""),
        ...
        cameraType: "Expected one of \"".concat(values(Camera.Type).join('", "'), "\""),
        codeDirection: "Expected one of \"".concat(values(ScanSettings.CodeDirection).join('", "'), "\""),
        guiStyle: "Expected one of \"".concat(values(BarcodePicker.GuiStyle).join('", "'), "\""),
...
var Controller = /*#__PURE__*/function () {
  function Controller(view) {
    ...
    _defineProperty(this, "allSymbologies", values(Barcode.Symbology).filter(function (s) {
  ...
  _createClass(Controller, [{
    ...
    value: function onScannerNewScanSettings(scanSettings) {
      ...
      var allSymbologies = values(Barcode.Symbology).filter(function (s) {
        return typeof s === "string";
      }); // tslint:disable-next-line: no-any
            ...
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                if (this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS] != null) {
                  ...
                  settings.desktop = _objectSpread(_objectSpread({}, SingleImageModeSettings.defaultDesktop), (_this$lazyAttributeCo = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].desktop) !== null && _this$lazyAttributeCo !== void 0 ? _this$lazyAttributeCo : {});
                  settings.mobile = _objectSpread(_objectSpread({}, SingleImageModeSettings.defaultMobile), (_this$lazyAttributeCo2 = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].mobile) !== null && _this$lazyAttributeCo2 !== void 0 ? _this$lazyAttributeCo2 : {});
...
var scanditDataCaptureLocation;
/**
 * @hidden
 */
...
function configure(licenseKey) {
  ...
  configurePromise = new promise( /*#__PURE__*/function () {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              if (/^https?:\/\//.test(engineLocation)) {
                scanditDataCaptureLocation = "".concat(engineLocation);
              } else {
                ...
                if (location.protocol === "file:" || location.origin === "null") {
                  scanditDataCaptureLocation = "".concat(location.href.split("/").slice(0, -1).join("/")).concat(engineLocation);
                } else {
                  scanditDataCaptureLocation = "".concat(location.origin).concat(engineLocation);
                }
              ...
              browserName = BrowserHelper.userAgentInfo.getBrowser().name;
              osName = BrowserHelper.userAgentInfo.getOS().name;
...
export { Barcode, BarcodePicker, BrowserCompatibility, BrowserHelper, Camera, CameraAccess, CameraSettings, CustomError, ImageSettings, Parser, ScanResult, ScanSettings, Scanner, SingleImageModeSettings, SymbologySettings, UAParser, blurryRecognitionPreloader, configure, configurePhase, configurePromise, dataCapture, dataCaptureLoader, dataCaptureWorkerBlob, deviceId, highEndBlurryRecognition, resetConfigure, scanditDataCaptureLocation, userLicenseKey };
