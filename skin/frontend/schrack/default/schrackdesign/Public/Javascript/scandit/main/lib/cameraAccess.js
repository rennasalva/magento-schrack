...
(function (CameraAccess) {
    ...
    function sortCamerasForCameraType(cameras, cameraType) {
        ...
        return cameraType === camera_1.Camera.Type.FRONT ? tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(frontCameras)), tslib_1.__read(backCameras)) : tslib_1.__spreadArray(tslib_1.__spreadArray([], tslib_1.__read(backCameras)), tslib_1.__read(frontCameras));
    }
    ...
    function extractAccessibleCamerasFromDevices(devices) {
        ...
        if (!browserHelper_1.BrowserHelper.isDesktopDevice() &&
            ...
            if (!cameraResolutions.some(function (cameraResolution) {
                ...
                backCameraIndex = cameraResolutions.lastIndexOf(Math.max.apply(Math, tslib_1.__spreadArray([], tslib_1.__read(cameraResolutions))));
            }
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        _a.label = 4;
                    case 4:
                        console.debug.apply(console, tslib_1.__spreadArray(["Camera list (devices):"], tslib_1.__read(availableVideoDevices)));
                    ...
                    case 7:
                        ...
                        console.debug.apply(console, tslib_1.__spreadArray(["Camera list (cameras): "], tslib_1.__read(cameras)));
                        // Return a copy of the array to allow for array mutations in other functions
                        return [2 /*return*/, tslib_1.__spreadArray([], tslib_1.__read(cameras))];
                }
            });
        });
    }
