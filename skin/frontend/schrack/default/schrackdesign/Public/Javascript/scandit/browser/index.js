...
(function (global, factory) {
	...
	var construct$2 = function (F, len, args) {
	  if (!(len in factories)) {
	...
	var _bind = Function.bind || function bind(that /* , ...args */) {
	  ...
	  var bound = function (/* args... */) {
	    ...
	    return this instanceof bound ? construct$2(fn, args.length, args) : invoke(fn, args, that);
	  };
	  if (isObject$7(fn.prototype)) bound.prototype = fn.prototype;
	  return bound;
	};
	...
	$export$h($export$h.S + $export$h.F * (NEW_TARGET_BUG || ARGS_BUG), 'Reflect', {
	  construct: function construct(Target, args /* , newTarget */) {
	    ...
	    var instance = create$3(isObject$6(proto) ? proto : Object.prototype);
	    var result = Function.apply.call(Target, instance, args);
	    return isObject$6(result) ? result : instance;
	  }
	});

	var construct$1 = _core.exports.Reflect.construct;

	var construct = construct$1;

	var $export$g = _export;
	// 19.1.2.4 / 15.2.3.6 Object.defineProperty(O, P, Attributes)
	$export$g($export$g.S + $export$g.F * !_descriptors, 'Object', { defineProperty: _objectDp.f });
	...
	// 19.1.2.2 / 15.2.3.5 Object.create(O [, Properties])
	$export$f($export$f.S, 'Object', { create: _objectCreate });
	...
	_objectGopd.f = _descriptors ? gOPD$2 : function getOwnPropertyDescriptor(O, P) {
	  ...
	  if (has$2(O, P)) return createDesc$2(!pIE$2.f.call(O, P), O[P]);
	};
	...
	$export$e($export$e.S, 'Object', { setPrototypeOf: _setProto.set });
	...
	var onFreeze = function (it) {
	  if (FREEZE && meta$1.NEED && isExtensible(it) && !has$1(it, META$1)) setMeta(it);
	  return it;
	};
	...
	_objectGopnExt.f = function getOwnPropertyNames(it) {
	  return windowNames && toString.call(it) == '[object Window]' ? getWindowNames(it) : gOPN$2(toIObject$3(it));
	};
	...
	var setSymbolDesc = DESCRIPTORS$4 && $fails(function () {
	...
	var $propertyIsEnumerable = function propertyIsEnumerable(key) {
	  var E = isEnum$1.call(this, key = toPrimitive(key, true));
	...
	if (!USE_NATIVE) {
	  $Symbol = function Symbol() {
	    ...
	    if (DESCRIPTORS$4 && setter) setSymbolDesc(ObjectProto, tag, { configurable: true, set: $set });
	    return wrap(tag);
	  };
	...
	$JSON$1 && $export$d($export$d.S + $export$d.F * (!USE_NATIVE || $fails(function () {
	  var S = $Symbol();
	...
	var _objectSap = function (KEY, exec) {
	  ...
	  var exp = {};
	  exp[KEY] = exec(fn);
	  $export$c($export$c.S + $export$c.F * fails$2(function () { fn(1); }), 'Object', exp);
	};
	...
	_objectSap('getPrototypeOf', function () {
	  return function getPrototypeOf(it) {
	    return $getPrototypeOf(toObject$3(it));
	  };
	});
	...
	$export$b($export$b.S + $export$b.F * !_iterDetect(function (iter) { Array.from(iter); }), 'Array', {
	  ...
	  from: function from(arrayLike /* , mapfn = undefined, thisArg = undefined */) {
	    ...
	    if (iterFn != undefined && !(C == Array && isArrayIter(iterFn))) {
	      for (iterator = iterFn.call(O), result = new C(); !(step = iterator.next()).done; index++) {
	        createProperty$1(result, index, mapping ? call(iterator, mapfn, [step.value, index], true) : step.value);
	      }
	    } else {
	...
	var _collectionStrong = {
	  getConstructor: function (wrapper, NAME, IS_MAP, ADDER) {
	    ...
	    if (DESCRIPTORS$3) dP$1(C.prototype, 'size', {
	      get: function () {
	...
	var _collection = function (NAME, wrapper, methods, common, IS_MAP, IS_WEAK) {
	  ...
	  O[NAME] = C;
	  $export$a($export$a.G + $export$a.W + $export$a.F, O);
	...
	$export$9($export$9.P + $export$9.R, 'Set', { toJSON: _collectionToJson('Set') });

	// https://tc39.github.io/proposal-setmap-offrom/
	var $export$8 = _export;

	var _setCollectionOf = function (COLLECTION) {
	  $export$8($export$8.S, COLLECTION, { of: function of() {
	...
	var _setCollectionFrom = function (COLLECTION) {
	  $export$7($export$7.S, COLLECTION, { from: function from(source /* , mapFn, thisArg */) {
	...
	(function (Barcode) {
	  ...
	  (function (Symbology) {
	    ...
	    var humanizedSymbologyNames = new map([[Symbology.AZTEC, "Aztec"], [Symbology.CODABAR, "Codabar"], [Symbology.CODE11, "Code 11"], [Symbology.CODE128, "Code 128"], [Symbology.CODE25, "Code 25"], [Symbology.CODE32, "Code 32"], [Symbology.CODE39, "Code 39"], [Symbology.CODE93, "Code 93"], [Symbology.DATA_MATRIX, "Data Matrix"], [Symbology.DOTCODE, "DotCode"], [Symbology.EAN13, "EAN-13"], [Symbology.EAN8, "EAN-8"], [Symbology.FIVE_DIGIT_ADD_ON, "Five-Digit Add-On"], [Symbology.GS1_DATABAR_EXPANDED, "GS1 DataBar Expanded"], [Symbology.GS1_DATABAR_LIMITED, "GS1 DataBar Limited"], [Symbology.GS1_DATABAR, "GS1 DataBar 14"], [Symbology.IATA_2_OF_5, "IATA 2 of 5"], [Symbology.INTERLEAVED_2_OF_5, "Interleaved 2 of 5"], [Symbology.KIX, "KIX"], [Symbology.LAPA4SC, "LAPA4SC"], [Symbology.MATRIX_2_OF_5, "Matrix 2 of 5"], [Symbology.MAXICODE, "MaxiCode"], [Symbology.MICRO_PDF417, "MicroPDF417"], [Symbology.MICRO_QR, "Micro QR"], [Symbology.MSI_PLESSEY, "MSI-Plessey"], [Symbology.PDF417, "PDF417"], [Symbology.QR, "QR"], [Symbology.RM4SCC, "RM4SCC"], [Symbology.TWO_DIGIT_ADD_ON, "Two-Digit Add-On"], [Symbology.UPCA, "UPC-A"], [Symbology.UPCE, "UPC-E"], [Symbology.USPS_INTELLIGENT_MAIL, "USPS Intelligent Mail"]]);
	    /**
	     * @hidden
	     */

	    var jsonSymbologyNames = new map([[Symbology.AZTEC, "aztec"], [Symbology.CODABAR, "codabar"], [Symbology.CODE11, "code11"], [Symbology.CODE128, "code128"], [Symbology.CODE25, "code25"], [Symbology.CODE32, "code32"], [Symbology.CODE39, "code39"], [Symbology.CODE93, "code93"], [Symbology.DATA_MATRIX, "data-matrix"], [Symbology.DOTCODE, "dotcode"], [Symbology.EAN13, "ean13"], [Symbology.EAN8, "ean8"], [Symbology.FIVE_DIGIT_ADD_ON, "five-digit-add-on"], [Symbology.GS1_DATABAR_EXPANDED, "databar-expanded"], [Symbology.GS1_DATABAR_LIMITED, "databar-limited"], [Symbology.GS1_DATABAR, "databar"], [Symbology.IATA_2_OF_5, "iata2of5"], [Symbology.INTERLEAVED_2_OF_5, "itf"], [Symbology.KIX, "kix"], [Symbology.LAPA4SC, "lapa4sc"], [Symbology.MATRIX_2_OF_5, "matrix2of5"], [Symbology.MAXICODE, "maxicode"], [Symbology.MICRO_PDF417, "micropdf417"], [Symbology.MICRO_QR, "microqr"], [Symbology.MSI_PLESSEY, "msi-plessey"], [Symbology.PDF417, "pdf417"], [Symbology.QR, "qr"], [Symbology.RM4SCC, "rm4scc"], [Symbology.TWO_DIGIT_ADD_ON, "two-digit-add-on"], [Symbology.UPCA, "upca"], [Symbology.UPCE, "upce"], [Symbology.USPS_INTELLIGENT_MAIL, "usps-intelligent-mail"]]); // tslint:enable:no-unnecessary-qualifier
	    ...
	    /**
	     * Get the JSON key name of a symbology, used for JSON-formatted ScanSettings and Scandit Data Capture library.
	     *
	     * @param symbology The symbology for which to retrieve the name.
	...
	function dataCapture() {
	  ...
	  function loadLibrary(deviceId, libraryLocation, locationPath, preload, newDelayedRegistration, newHighEndBlurryRecognition, newLicenseKey, deviceModelName) {
	    ...
	    Module = {
	      ...
	      instantiateWasm: function instantiateWasm(importObject, successCallback) {
	        ...
	        if (wasmJSVersion !== "5.7.1") {
	          console.error("The Scandit Data Capture library JS file found at ".concat(jsURI, " seems invalid: ") + "expected version doesn't match (received: ".concat(wasmJSVersion, ", expected: ", "5.7.1", "). ") + "Please ensure the correct Scandit Data Capture file (with correct version) is retrieved.");
	        }
	    ...
	    return retryWithExponentialBackoff(tryImportScripts, 250, 4000, function (error) {
	      console.warn(error);
	      console.warn("Couldn't retrieve Scandit Data Capture library at ".concat(jsURI, ", retrying..."));
	    }).catch(function (error) {
	      console.error(error);
	      console.error("Couldn't retrieve Scandit Data Capture library at ".concat(jsURI, ", did you configure the path for it correctly?"));
	      return Promise.resolve(error); // Promise is used only during testing
	    });
	  }

	  function createContext( // tslint:disable-next-line: bool-param-default
	  newDelayedRegistration, // tslint:disable-next-line: bool-param-default
	  newHighEndBlurryRecognition, newLicenseKey) {
	    ...
	    if (!wasmReady || delayedRegistration == null || highEndBlurryRecognition == null || !workSubmitted && !delayedRegistration || licenseKey == null) {
	      return;
	    }
	    ...
	    Module._create_context(licenseKeyPointer, writableDataPathPointer, delayedRegistration, highEndBlurryRecognition, false);
	  ...
	  function createBlurryTable(symbology) {
	    ...
	    Module._free(symbologyPointer); // FS.syncfs is called by data capture if needed: the current promise is the one to wait for
	  ...
	  function getLibraryLocationURIs(libraryLocation) {
	    ...
	    if (/^https?:\/\/([^\/.]*\.)*cdn.jsdelivr.net\//.test(libraryLocation)) {
	      libraryLocation = "https://cdn.jsdelivr.net/npm/scandit-sdk@5.7.1/build/";
	      cdnURI = true;
	    } else if (/^https?:\/\/([^\/.]*\.)*unpkg.com\//.test(libraryLocation)) {
	      libraryLocation = "https://unpkg.com/scandit-sdk@5.7.1/build/";
	      cdnURI = true;
	    }
	    ...
	    return {
	      jsURI: "".concat(libraryLocation, "scandit-engine-sdk.min.js?v=5.7.1"),
	      wasmURI: "".concat(libraryLocation, "scandit-engine-sdk.wasm?v=5.7.1")
	    };
	  }
	  ...
	  function applyScanSettings() {
	    ...
	    const resultPointer = Module._scanner_settings_new_from_json(scanSettingsPointer, parsedSettings.blurryRecognition && blurryRecognitionAvailable, (_parsedSettings$matri = parsedSettings.matrixScanEnabled) !== null && _parsedSettings$matri !== void 0 ? _parsedSettings$matri : false, highQualitySingleFrameMode, gpuAccelerationAvailable && parsedSettings.gpuAcceleration);
	    ...
	    if (result !== "") {
	      ...
	      console.debug("External Scandit Data Capture scan settings:", JSON.parse(result));
	    }
	  }
	  ...
	  function verifiedWasmFetch(wasmURI, awaitFullResponse) {
	    function verifyResponseData(responseData) {
	      ...
	      if (typeof ((_crypto = crypto) === null || _crypto === void 0 ? void 0 : (_crypto$subtle = _crypto.subtle) === null || _crypto$subtle === void 0 ? void 0 : _crypto$subtle.digest) === "function") {
	        crypto.subtle.digest("SHA-256", responseData).then(function (hash) {
	          ...
	          if (hashString !== "d4220c15461dd4c65c155c84811b085b21b17df5febe1ad68dfdc55a66cfaa85") {
	            console.error("The Scandit Data Capture library WASM file found at ".concat(wasmURI, " seems invalid: ") + "expected file hash doesn't match (received: ".concat(hashString, ", ") + "expected: ".concat("d4220c15461dd4c65c155c84811b085b21b17df5febe1ad68dfdc55a66cfaa85", "). ") + "Please ensure the correct Scandit Data Capture file (with correct version) is retrieved.");
	          }
	        }).catch(
	        /* istanbul ignore next */
	        function () {// Ignored
	        ...
	        console.warn("Insecure context (see https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts): " + "The hash of the Scandit Data Capture library WASM file found at ".concat(wasmURI, " could not be verified"));
	      }
	    }
	    ...
	    return retryWithExponentialBackoff(tryFetch, 250, 4000, function (error) {
	      console.warn(error);
	      console.warn("Couldn't retrieve Scandit Data Capture library at ".concat(wasmURI, ", retrying..."));
	    }).catch(function (error) {
	      console.error(error);
	      console.error("Couldn't retrieve/instantiate Scandit Data Capture library at ".concat(wasmURI, ", ") + "did you configure the path for it correctly?");
	      return Promise.reject(error);
	    });
	  }
	  ...
	  function instantiateWebAssembly(importObject, wasmURI, successCallback) {
	    verifiedWasmFetch(wasmURI, true).then(function (response) {
	      ...
	      return self.WebAssembly.instantiate(bytes, importObject).then(function (results) {
	        ...
	        console.error(error);
	        console.error("Couldn't instantiate Scandit Data Capture library at ".concat(wasmURI, ", ") + "did you configure the path for it correctly?");
	      });
	    }).catch(
	    /* istanbul ignore next */
	    function () {// Ignored
	  ...
	  onmessage = function onmessage(e) {
	    ...
	    switch (data.type) {
	      case "load-library":
	        ...
	        dataCaptureInstance.loadLibrary(data.deviceId, data.libraryLocation, data.path, data.preload, data.delayedRegistration, data.highEndBlurryRecognition, data.licenseKey, data.deviceModelName);
	        break;
	...
	const dataCaptureWorkerBlob = new Blob(["var Module;".concat(dataCapture.toString(), "(").concat(edataCaptureWorkerFunction.toString(), ")()")], {
	  type: "text/javascript"
	});

	var DataCaptureLoader = /*#__PURE__*/function () {
	  function DataCaptureLoader(preload) {
	    _classCallCheck(this, DataCaptureLoader);

	    _defineProperty(this, "preloadedDataCaptureWorker", void 0);

	    _defineProperty(this, "preloadedDataCaptureWorkerAvailable", void 0);
	  ...
	  _createClass(DataCaptureLoader, [{
	    key: "getDataCaptureWorker",
	    value: function getDataCaptureWorker() {
	    ...
	    value: function returnDataCaptureWorker(dataCaptureWorker) {
	    ...
	    key: "load",
	    value: function load(dataCaptureWorker) {
	      ...
	      dataCaptureWorker.postMessage({
	        type: "load-library",
	        deviceId,
	        libraryLocation: exports.scanditDataCaptureLocation,
	        path: window.location.pathname,
	        preload,
	        delayedRegistration,
	        highEndBlurryRecognition: exports.highEndBlurryRecognition,
	...
	var BlurryRecognitionPreloader = /*#__PURE__*/function () {
	  ...
	  function BlurryRecognitionPreloader(preload) {
	    _classCallCheck(this, BlurryRecognitionPreloader);

	    _defineProperty(this, "eventEmitter", new eventemitter3.exports.EventEmitter());

	    _defineProperty(this, "preload", void 0);

	    _defineProperty(this, "queuedBlurryRecognitionSymbologies", from$1(BlurryRecognitionPreloader.availableBlurryRecognitionSymbologies.values()));

	    _defineProperty(this, "readyBlurryRecognitionSymbologies", new set());

	    _defineProperty(this, "engineWorker", void 0);

	    this.preload = preload;
	  }

	  _createClass(BlurryRecognitionPreloader, [{
	    key: "prepareBlurryTables",
	    value: function () {
	      var _prepareBlurryTables = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	        ...
	        openDbRequest.onsuccess = function () {
	          try {
	            ...
	            storeKeysRequest.onsuccess = function () {
	              ...
	              if ((exports.highEndBlurryRecognition ? BlurryRecognitionPreloader.highEndBlurryTableFiles : BlurryRecognitionPreloader.defaultBlurryTableFiles).every(function (file) {
	    ...
	    key: "create",
	    value: function () {
	      var _create = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(preload) {
	...
	var CustomError = /*#__PURE__*/function (_Error) {
	  ...
	  var _super = _createSuper$3(CustomError);
	...
	var UnsupportedBrowserError = /*#__PURE__*/function (_CustomError) {
	  _inherits(UnsupportedBrowserError, _CustomError);

	  var _super = _createSuper$2(UnsupportedBrowserError);

	  // istanbul ignore next
	  function UnsupportedBrowserError(browserCompatibility) {
	    var _this;

	    _classCallCheck(this, UnsupportedBrowserError);
	...
	$export$5($export$5.S, 'Array', { isArray: _isArray });

	var isArray$1 = _core.exports.Array.isArray;
	...
	function _iterableToArray(iter) {
	  if (typeof symbol !== "undefined" && iter[iterator] != null || iter["@@iterator"] != null) return from$1(iter);
	}
	...
	var ScanResult = /*#__PURE__*/function () {
	  ...
	  function ScanResult(barcodes, imageData, imageSettings) {
	    ...
	    _defineProperty(this, "barcodes", void 0);

	    _defineProperty(this, "imageData", void 0);

	    _defineProperty(this, "imageSettings", void 0);

	    _defineProperty(this, "rejectedCodes", void 0);
	...
	var values$1 = _core.exports.Object.values;
	...
	exports.SymbologySettings = /*#__PURE__*/function () {
	  ...
	  function SymbologySettings(symbology) {
	    ...
	    _defineProperty(this, "symbology", void 0);

	    _defineProperty(this, "enabled", void 0);

	    _defineProperty(this, "colorInvertedEnabled", void 0);

	    _defineProperty(this, "activeSymbolCounts", void 0);

	    _defineProperty(this, "extensions", void 0);

	    _defineProperty(this, "checksums", void 0);
	    ...
	    this.extensions = new set((_SymbologySettings$de2 = SymbologySettings.defaultExtensions[symbology]) !== null && _SymbologySettings$de2 !== void 0 ? _SymbologySettings$de2 : []);
	    this.checksums = new set((_SymbologySettings$de3 = SymbologySettings.defaultChecksums[symbology]) !== null && _SymbologySettings$de3 !== void 0 ? _SymbologySettings$de3 : []);
	  }
	  /**
	  ...
	  _createClass(SymbologySettings, [{
	    ...
	    value: function enableExtensions(extension) {
	      ...
	      if (typeof extension === "object") {
	        this.extensions = new set([].concat(_toConsumableArray(this.extensions), _toConsumableArray(from$1(extension).filter(function (e) {
	    ...
	    value: function disableExtensions(extension) {
	      if (typeof extension === "object") {
	        this.extensions = new set(_toConsumableArray(this.extensions).filter(function (x) {
	    ...
	    value: function enableChecksums(checksum) {
	      ...
	      if (typeof checksum === "object") {
	        this.checksums = new set([].concat(_toConsumableArray(this.checksums), _toConsumableArray(from$1(checksum).filter(function (c) {
	    ...
	    value: function disableChecksums(checksum) {
	      if (typeof checksum === "object") {
	        this.checksums = new set(_toConsumableArray(this.checksums).filter(function (x) {
	    ...
	    value: function isValidExtension(extension) {
	      return extension in SymbologySettings.Extension || values(SymbologySettings.Extension).includes(extension.toLowerCase());
	    }
	  }, {
	    key: "isValidChecksum",
	    value: function isValidChecksum(checksum) {
	      return checksum in SymbologySettings.Checksum || values(SymbologySettings.Checksum).includes(checksum.toLowerCase());
	    }
	  }]);
	...
	function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof symbol !== "undefined" && o[iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it.return != null) it.return(); } finally { if (didErr) throw err; } } }; }
	...
	exports.ScanSettings = /*#__PURE__*/function () {
	  ...
	  function ScanSettings() {
	    ...
	    _defineProperty(this, "symbologySettings", void 0);

	    _defineProperty(this, "properties", void 0);

	    _defineProperty(this, "codeDuplicateFilter", void 0);

	    _defineProperty(this, "maxNumberOfCodesPerFrame", void 0);

	    _defineProperty(this, "baseSearchArea", void 0);

	    _defineProperty(this, "searchArea", void 0);

	    _defineProperty(this, "gpuAcceleration", void 0);

	    _defineProperty(this, "blurryRecognition", void 0);

	    _defineProperty(this, "codeDirectionHint", void 0);
	  ...
	  _createClass(ScanSettings, [{
	    ...
	    value: function getSymbologySettings(symbology) {
	      if (this.symbologySettings.has(symbology)) {
	        ...
	        if (symbology in exports.Barcode.Symbology || values(exports.Barcode.Symbology).includes(symbology)) {
	    ...
	    /**
	     * Get a Scandit Data Capture library property.
	     *
	    ...
	    /**
	     * Set a Scandit Data Capture library property.
	     *
	     * This function is for internal use only and any functionality that can be accessed through it can and will vanish
	     * without public notice from one version to the next. Do not call this function unless you specifically have to.
	     *
	    ...
	    value: function setMultipleSymbologiesEnabled(symbology, enabled) {
	      ...
	      try {
	        for (_iterator.s(); !(_step = _iterator.n()).done;) {
	          ...
	          if (!(s in exports.Barcode.Symbology || values(exports.Barcode.Symbology).includes(s))) {
	...
	var Scanner = /*#__PURE__*/function () {
	  ...
	  function Scanner() {
	    ...
	    _defineProperty(this, "dataCaptureWorker", void 0);

	    _defineProperty(this, "eventEmitter", void 0);

	    _defineProperty(this, "scanSettings", void 0);

	    _defineProperty(this, "imageSettings", void 0);

	    _defineProperty(this, "workerParseRequestId", void 0);

	    _defineProperty(this, "workerScanQueueLength", void 0);

	    _defineProperty(this, "isReadyToWork", void 0);

	    _defineProperty(this, "licenseKeyFeatures", void 0);

	    _defineProperty(this, "imageDataConversionContext", void 0);

	    _defineProperty(this, "activeBlurryRecognitionSymbologies", void 0);

	    _defineProperty(this, "blurryRecognitionAvailable", void 0);
	    ...
	    this.eventEmitter = new eventemitter3.exports.EventEmitter();
	    this.isReadyToWork = false;
	    this.workerScanQueueLength = 0;
	    this.workerParseRequestId = 0;
	    this.dataCaptureWorker = exports.dataCaptureLoader.getDataCaptureWorker();
	  ...
	  _createClass(Scanner, [{
	    ...
	    function destroy() {
	      if (this.dataCaptureWorker != null) {
	        exports.dataCaptureLoader.returnDataCaptureWorker(this.dataCaptureWorker);
	      }
	    ...
	    value: function applyScanSettings(scanSettings) {
	      ...
	      var deviceName = this.scanSettings.getDeviceName();
	      ...
	      if (this.blurryRecognitionAvailable) {
	        this.activeBlurryRecognitionSymbologies = new set([].concat(_toConsumableArray(this.activeBlurryRecognitionSymbologies), _toConsumableArray(activeBlurryRecognitionSymbologies)));
	      }
	    ...
	    key: "processImage",
	    value: function () {
	      var _processImage = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(imageData) {
	        var _this2 = this;
	              ...
	              case 17:
	                ...
	                return _context.abrupt("return", new promise(function (resolve, reject) {
	                  ...
	                  _this2.eventEmitter.once(workErrorEvent, function (error, _) {
	                    console.error("Scandit Data Capture error (".concat(error.errorCode, "):"), error.errorMessage);
	                  ...
	                  _this2.dataCaptureWorker.postMessage({
	                    type: "scan-image",
	    ...
	    key: "parse",
	    value: function () {
	      var _parse = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(dataFormat, data, options) {
	        var _this3 = this;
	            ...
	            switch (_context2.prev = _context2.next) {
	              case 0:
	                ...
	                return _context2.abrupt("return", new promise(function (resolve, reject) {
	                  ...
	                  _this3.dataCaptureWorker.postMessage({
	                    type: "parse",
	                    requestId: _this3.workerParseRequestId,
	                    dataFormat,
	                    data,
	                    options: options == null ? "{}" : stringify(options)
	                  });
	                }));
	    ...
	    value: function handleBlurryTablesUpdate() {
	      ...
	      if (this.blurryRecognitionAvailable) {
	        this.activeBlurryRecognitionSymbologies = new set([].concat(_toConsumableArray(this.activeBlurryRecognitionSymbologies), _toConsumableArray(exports.blurryRecognitionPreloader.getEnabledSymbologies(this.scanSettings))));
	        this.dataCaptureWorker.postMessage({
	          type: "scan-settings",
	          settings: this.scanSettings.toJSONString(),
	    ...
	    value: function dataCaptureWorkerOnMessage(ev) {
	      var data = ev.data;
	...
	_defineProperty(Scanner, "workerScanRequestId", 0);
	...
	var getOwnPropertySymbols$1 = _core.exports.Object.getOwnPropertySymbols;
	...
	var getOwnPropertyDescriptors$1 = _core.exports.Object.getOwnPropertyDescriptors;
	...
	$export$1($export$1.G + $export$1.F * (parseInt != $parseInt), { parseInt: $parseInt });

	var _parseInt$1 = _core.exports.parseInt;

	var _parseInt = _parseInt$1;

	function ownKeys$2(object, enumerableOnly) { var keys = Object.keys(object); if (getOwnPropertySymbols) { var symbols = getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	(function (CameraAccess) {
	  ...
	  function sortCamerasForCameraType(cameras, cameraType) {
	    ...
	    return cameraType === exports.Camera.Type.FRONT ? [].concat(_toConsumableArray(frontCameras), _toConsumableArray(backCameras)) : [].concat(_toConsumableArray(backCameras), _toConsumableArray(frontCameras));
	  }
	  ...
	  function extractAccessibleCamerasFromDevices(devices) {
	    ...
	    if (!exports.BrowserHelper.isDesktopDevice() && cameras.length > 1 && !cameras.some(function (camera) {
	      ...
	      if (!cameraResolutions.some(function (cameraResolution) {
	        ...
	        backCameraIndex = cameraResolutions.lastIndexOf(Math.max.apply(Math, _toConsumableArray(cameraResolutions)));
	      }
	  ...
	  function _getStreamForDeviceAccessPermission() {
	    _getStreamForDeviceAccessPermission = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	      return regenerator.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	  ...
	  function _getCameras() {
	    _getCameras = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
	      var _console2;
	      ...
	      return regenerator.wrap(function _callee2$(_context2) {
	        while (1) {
	          switch (_context2.prev = _context2.next) {
	            ...
	            case 18:
	              (_console = console).debug.apply(_console, ["Camera list (devices):"].concat(_toConsumableArray(availableVideoDevices)));
	            ...
	            case 29:
	              ...
	              (_console2 = console).debug.apply(_console2, ["Camera list (cameras): "].concat(_toConsumableArray(cameras))); // Return a copy of the array to allow for array mutations in other functions


	              return _context2.abrupt("return", _toConsumableArray(cameras));
	  ...
	  function getUserMediaDelayed(getUserMediaParams) {
	    ...
	    return new promise(function (resolve, reject) {
	      window.setTimeout(function () {
	        ...
	        ((_navigator$mediaDevic = navigator.mediaDevices.getUserMedia(getUserMediaParams)) !== null && _navigator$mediaDevic !== void 0 ? _navigator$mediaDevic : promise.reject(new CustomError({
	          name: "AbortError"
	  ...
	  function getUserMediaVideoParams(cameraResolutionConstraint) {
	    ...
	    switch (cameraResolutionConstraint) {
	      case CameraResolutionConstraint.ULTRA_HD:
	        return _objectSpread$2(_objectSpread$2({}, userMediaVideoParams), {}, {
	          width: {
	            min: 3200,
	            ideal: 3840,
	            max: 4096
	  ...
	  function _accessCameraStream() {
	    _accessCameraStream = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(cameraResolutionConstraint, camera) {
	  ...
	  function _enumerateVideoDevices() {
	    _enumerateVideoDevices = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
	...
	function ownKeys$1(object, enumerableOnly) { var keys = Object.keys(object); if (getOwnPropertySymbols) { var symbols = getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }
	...
	var CameraManager = /*#__PURE__*/function () {
	  function CameraManager(scanner, triggerFatalError, gui) {
	    ...
	    _defineProperty(this, "selectedCamera", void 0);

	    _defineProperty(this, "activeCamera", void 0);

	    _defineProperty(this, "activeCameraSettings", void 0);

	    _defineProperty(this, "scanner", void 0);

	    _defineProperty(this, "triggerFatalError", void 0);

	    _defineProperty(this, "gui", void 0);

	    _defineProperty(this, "postStreamInitializationListener", this.postStreamInitialization.bind(this));

	    _defineProperty(this, "videoResizeListener", this.videoResizeHandle.bind(this));

	    _defineProperty(this, "videoTrackEndedListener", this.videoTrackEndedRecovery.bind(this));

	    _defineProperty(this, "videoTrackMuteListener", this.videoTrackMuteRecovery.bind(this));

	    _defineProperty(this, "triggerManualFocusListener", this.triggerManualFocus.bind(this));

	    _defineProperty(this, "triggerZoomStartListener", this.triggerZoomStart.bind(this));
	    ...
	    _defineProperty(this, "mediaStream", void 0);

	    _defineProperty(this, "mediaTrackCapabilities", void 0);

	    _defineProperty(this, "cameraAccessTimeout", void 0);

	    _defineProperty(this, "videoMetadataCheckInterval", void 0);

	    _defineProperty(this, "getCapabilitiesTimeout", void 0);

	    _defineProperty(this, "autofocusInterval", void 0);

	    _defineProperty(this, "manualToAutofocusResumeTimeout", void 0);

	    _defineProperty(this, "manualFocusWaitTimeout", void 0);

	    _defineProperty(this, "cameraSwitcherEnabled", void 0);

	    _defineProperty(this, "torchToggleEnabled", void 0);

	    _defineProperty(this, "tapToFocusEnabled", void 0);

	    _defineProperty(this, "pinchToZoomEnabled", void 0);

	    _defineProperty(this, "pinchToZoomDistance", void 0);

	    _defineProperty(this, "pinchToZoomInitialZoom", void 0);

	    _defineProperty(this, "torchEnabled", void 0);

	    _defineProperty(this, "cameraInitializationPromise", void 0);

	    _defineProperty(this, "cameraSetupPromise", void 0);
	  ...
	  _createClass(CameraManager, [{
	    ...
	    value: function () {
	      var _setCameraSwitcherEnabled = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(enabled) {
	        var cameras;
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	    ...
	    key: "setCameraType",
	    value: function () {
	      var _setCameraType = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(cameraType) {
	        var mainCameraForType;
	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	    ...
	    key: "setupCameras",
	    value: function () {
	      var _setupCameras = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
	        return regenerator.wrap(function _callee3$(_context3) {
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              case 0:
	    ...
	    key: "stopStream",
	    value: function () {
	      var _stopStream = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
	        var _this = this;
	          ...
	          while (1) {
	            switch (_context4.prev = _context4.next) {
	              case 0:
	                ...
	                window.clearInterval(this.autofocusInterval); // Pause video and asynchronously stop tracks to prevent bug on some Android devices freezing the camera on Chrome
	                ...
	                return _context4.abrupt("return", new promise(function (resolve) {
	                  setTimeout(function () {
	                    ...
	                    (_this$mediaStream = _this.mediaStream) === null || _this$mediaStream === void 0 ? void 0 : _this$mediaStream.getVideoTracks().forEach(function (track) {
	                      track.removeEventListener("ended", _this.videoTrackEndedListener);
	                      track.stop();
	                    });
	                    _this.gui.videoElement.srcObject = null;
	                    _this.mediaStream = undefined;
	                    _this.mediaTrackCapabilities = undefined;
	                    resolve();
	                  }, 0);
	                }));
	    ...
	    value: function () {
	      var _applyCameraSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(cameraSettings) {
	        return regenerator.wrap(function _callee5$(_context5) {
	          while (1) {
	            switch (_context5.prev = _context5.next) {
	              ...
	              case 3:
	                return _context5.abrupt("return", this.initializeCameraWithSettings(this.activeCamera, cameraSettings));
	    ...
	    value: function () {
	      var _reinitializeCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6() {
	          ...
	          while (1) {
	            switch (_context6.prev = _context6.next) {
	              ...
	              case 10:
	                ...
	                console.warn("Couldn't access camera:", this.activeCamera, _context6.t0);
	                this.triggerFatalError(_context6.t0);
	                throw _context6.t0;
	    ...
	    value: function () {
	      var _initializeCameraWithSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7(camera, cameraSettings) {
	          ...
	          while (1) {
	            switch (_context7.prev = _context7.next) {
	              ...
	              case 3:
	                ...
	                return _context7.abrupt("return", this.cameraInitializationPromise);
	    ...
	    key: "setTorchEnabled",
	    value: function () {
	      var _setTorchEnabled = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8(enabled) {
	    ...
	    key: "toggleTorch",
	    value: function () {
	      var _toggleTorch = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9() {
	    ...
	    key: "setZoom",
	    value: function () {
	      var _setZoom = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10(zoomPercentage, currentZoom) {
	    ...
	    value: function () {
	      var _recoverStreamIfNeeded = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11() {
	        var _this$mediaStream2, _videoTracks$;
	          ...
	          while (1) {
	            switch (_context11.prev = _context11.next) {
	              case 0:
	                ...
	                videoTracks = (_this$mediaStream2 = this.mediaStream) === null || _this$mediaStream2 === void 0 ? void 0 : _this$mediaStream2.getVideoTracks();
	    ...
	    value: function () {
	      var _setupCamerasAndStream = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12() {
	        var _this$mediaStream3, _this$mediaStream3$ge, _this$mediaStream3$ge2, initialCamera, cameras, initialCameraDeviceId, activeCamera;
	          ...
	          while (1) {
	            switch (_context12.prev = _context12.next) {
	              ...
	              case 7:
	                ...
	                initialCameraDeviceId = (_this$mediaStream3 = this.mediaStream) === null || _this$mediaStream3 === void 0 ? void 0 : (_this$mediaStream3$ge = _this$mediaStream3.getVideoTracks()[0]) === null || _this$mediaStream3$ge === void 0 ? void 0 : (_this$mediaStream3$ge2 = _this$mediaStream3$ge.getSettings) === null || _this$mediaStream3$ge2 === void 0 ? void 0 : _this$mediaStream3$ge2.call(_this$mediaStream3$ge).deviceId;
	    ...
	    value: function () {
	      var _accessAutoselectedCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee13(cameras) {
	          ...
	          while (1) {
	            switch (_context13.prev = _context13.next) {
	              ...
	              case 9:
	                ...
	                console.warn("Couldn't access camera:", autoselectedCamera, _context13.t0);
	                autoselectedCamera = cameras.shift();
	    ...
	    value: function () {
	      var _accessInitialCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee14() {
	        var initialCamera;
	        return regenerator.wrap(function _callee14$(_context14) {
	          while (1) {
	            switch (_context14.prev = _context14.next) {
	              ...
	              case 11:
	                return _context14.abrupt("return", initialCamera);
	    ...
	    value: function () {
	      var _videoTrackEndedRecovery = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee15() {
	    ...
	    value: function () {
	      var _videoTrackMuteRecovery = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee16() {
	    ...
	    value: function () {
	      var _triggerManualFocusForContinuous = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee19() {
	        var _this3 = this;
	        ...
	        return regenerator.wrap(function _callee19$(_context19) {
	          while (1) {
	            switch (_context19.prev = _context19.next) {
	              case 0:
	                this.manualToAutofocusResumeTimeout = window.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee17() {
	              ...
	              case 3:
	                this.manualFocusWaitTimeout = window.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee18() {
	    ...
	    value: function () {
	      var _triggerManualFocusForSingleShot = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee20() {
	        var _this4 = this;
	    ...
	    value: function () {
	      var _triggerManualFocus = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee21(event) {
	    ...
	    key: "triggerZoomMove",
	    value: function () {
	      var _triggerZoomMove = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee22(event) {
	    ...
	    value: function () {
	      var _triggerAutoFocus = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee23() {
	    ...
	    value: function () {
	      var _triggerFocusMode = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee24(focusMode) {
	        var videoTracks;
	    ...
	    value: function () {
	      var _initializeCameraAndCheckUpdatedSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee25(camera) {
	        var _this7 = this;
	        ...
	        return regenerator.wrap(function _callee25$(_context25) {
	          while (1) {
	            switch (_context25.prev = _context25.next) {
	              ...
	              case 3:
	                if (!(this.selectedCameraSettings !== this.activeCameraSettings && (this.selectedCameraSettings == null || this.activeCameraSettings == null || Object.keys(this.selectedCameraSettings).some(function (cameraSettingsProperty) {
	    ...
	    value: function () {
	      var _handleCameraInitializationError = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee26(camera, cameraResolutionConstraint, error) {
	          ...
	          while (1) {
	            switch (_context26.prev = _context26.next) {
	              ...
	              case 17:
	                ...
	                return _context26.abrupt("return", this.initializeCamera(camera));
	    ...
	    value: function () {
	      var _initializeCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee27(camera, cameraResolutionConstraint) {
	        var _cameraResolutionCons,
	            _this8 = this;

	        var stream, mediaTrackSettings, browserName;
	        return regenerator.wrap(function _callee27$(_context27) {
	          while (1) {
	            switch (_context27.prev = _context27.next) {
	              ...
	              case 19:
	                return _context27.abrupt("return", this.initializeCamera(camera, cameraResolutionConstraint + 1));
	              ...
	              case 37:
	                ...
	                return _context27.abrupt("return", this.handleCameraInitializationError(camera, cameraResolutionConstraint, _context27.t1));
	    ...
	    value: function () {
	      var _checkCameraAccess = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee29(camera) {
	        var _this9 = this;
	        ...
	        return regenerator.wrap(function _callee29$(_context29) {
	          while (1) {
	            switch (_context29.prev = _context29.next) {
	              case 0:
	                window.clearTimeout(this.cameraAccessTimeout);
	                return _context29.abrupt("return", new promise(function (_, reject) {
	                  _this9.cameraAccessTimeout = window.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee28() {
	    ...
	    value: function () {
	      var _checkVideoMetadata = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee31(camera) {
	        var _this10 = this;
	              ...
	              case 0:
	                return _context31.abrupt("return", new promise(function (resolve, reject) {
	                  _this10.gui.videoElement.onloadeddata = function () {
	                    ...
	                    _this10.videoMetadataCheckInterval = window.setInterval( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee30() {
	                        ...
	                        while (1) {
	                          switch (_context30.prev = _context30.next) {
	                            case 0:
	                              ...
	                              window.clearInterval(_this10.videoMetadataCheckInterval);
	                              _context30.next = 6;
	                              return _this10.stopStream();

	                            case 6:
	                              return _context30.abrupt("return", reject(new CustomError(CameraManager.notReadableErrorParameters)));
	    ...
	    value: function setupCameraStreamVideo(camera, stream) {
	      ...
	      var cameraStreamVideoCheck = promise.race([this.checkCameraAccess(camera), this.checkVideoMetadata(camera)]);
	...
	_defineProperty(CameraManager, "cameraAccessTimeoutMs", 4000);

	_defineProperty(CameraManager, "videoMetadataCheckTimeoutMs", 4000);

	_defineProperty(CameraManager, "videoMetadataCheckIntervalMs", 50);

	_defineProperty(CameraManager, "getCapabilitiesTimeoutMs", 500);

	_defineProperty(CameraManager, "autofocusIntervalMs", 1500);

	_defineProperty(CameraManager, "manualToAutofocusResumeTimeoutMs", 5000);

	_defineProperty(CameraManager, "manualFocusWaitTimeoutMs", 400);

	_defineProperty(CameraManager, "noCameraErrorParameters", {
	  name: "NoCameraAvailableError",
	  message: "No camera available"
	});

	_defineProperty(CameraManager, "notReadableErrorParameters", {
	...
	var DummyCameraManager = /*#__PURE__*/function (_CameraManager) {
	  ...
	  var _super = _createSuper$1(DummyCameraManager);
	  ...
	  _createClass(DummyCameraManager, [{
	    ...
	    key: "setCameraSwitcherEnabled",
	    value: function () {
	      var _setCameraSwitcherEnabled = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(_1) {
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	    ...
	    key: "setCameraType",
	    value: function () {
	      var _setCameraType = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(_1) {
	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	    ...
	    key: "applyCameraSettings",
	    value: function () {
	      var _applyCameraSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(_1) {
	        return regenerator.wrap(function _callee5$(_context5) {
	          while (1) {
	            switch (_context5.prev = _context5.next) {
	              case 0:
	    ...
	    key: "initializeCameraWithSettings",
	    value: function () {
	      var _initializeCameraWithSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7(_1, _2) {
	        return regenerator.wrap(function _callee7$(_context7) {
	          while (1) {
	            switch (_context7.prev = _context7.next) {
	              case 0:
	    ...
	    key: "setTorchEnabled",
	    value: function () {
	      var _setTorchEnabled = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8(_1) {
	        return regenerator.wrap(function _callee8$(_context8) {
	          while (1) {
	            switch (_context8.prev = _context8.next) {
	              case 0:
	    ...
	    key: "setZoom",
	    value: function () {
	      var _setZoom = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10(_1, _2) {
	        return regenerator.wrap(function _callee10$(_context10) {
	          while (1) {
	            switch (_context10.prev = _context10.next) {
	              case 0:
	...
	var ResizeObserver = (_window$ResizeObserve = window.ResizeObserver) !== null && _window$ResizeObserve !== void 0 ? _window$ResizeObserve : ResizeObserver$1;
	var GUI = /*#__PURE__*/function () {
	  function GUI(options) {
	    ...
	    _defineProperty(this, "cameraSwitcherElement", void 0);

	    _defineProperty(this, "torchTogglerElement", void 0);

	    _defineProperty(this, "scanner", void 0);

	    _defineProperty(this, "singleImageModeEnabled", void 0);

	    _defineProperty(this, "singleImageModeSettings", void 0);

	    _defineProperty(this, "grandParentElement", void 0);

	    _defineProperty(this, "parentElement", void 0);

	    _defineProperty(this, "laserContainerElement", void 0);

	    _defineProperty(this, "laserActiveImageElement", void 0);

	    _defineProperty(this, "laserPausedImageElement", void 0);

	    _defineProperty(this, "viewfinderElement", void 0);

	    _defineProperty(this, "cameraUploadElement", void 0);

	    _defineProperty(this, "cameraUploadLabelElement", void 0);

	    _defineProperty(this, "cameraUploadInputElement", void 0);

	    _defineProperty(this, "cameraUploadProgressElement", void 0);

	    _defineProperty(this, "visibilityListener", void 0);

	    _defineProperty(this, "videoPauseListener", void 0);

	    _defineProperty(this, "videoResizeListener", void 0);

	    _defineProperty(this, "newScanSettingsListener", void 0);

	    _defineProperty(this, "contextCreatedShowLogoListener", void 0);

	    _defineProperty(this, "contextCreatedActivateGUIListener", void 0);

	    _defineProperty(this, "resizeObserver", void 0);

	    _defineProperty(this, "cameraUploadCallback", void 0);

	    _defineProperty(this, "mirrorImageOverrides", void 0);

	    _defineProperty(this, "contextWebGL", void 0);

	    _defineProperty(this, "context2d", void 0);

	    _defineProperty(this, "cameraManager", void 0);

	    _defineProperty(this, "originElement", void 0);

	    _defineProperty(this, "scanningPaused", void 0);

	    _defineProperty(this, "visible", void 0);

	    _defineProperty(this, "guiStyle", void 0);

	    _defineProperty(this, "videoFit", void 0);

	    _defineProperty(this, "customLaserArea", void 0);

	    _defineProperty(this, "customViewfinderArea", void 0);

	    _defineProperty(this, "cameraUploadInProgress", void 0);

	    _defineProperty(this, "cameraSwitchInProgress", void 0);

	    _defineProperty(this, "dataCaptureContextCreated", void 0);
	  ...
	  _createClass(GUI, [{
	    ...
	    value: function getImageData(imageData) {
	      ...
	      if (!this.singleImageModeEnabled) {
	        if (this.contextWebGL != null) {
	          ...
	          this.contextWebGL.readPixels(0, 0, this.contextWebGL.drawingBufferWidth, this.contextWebGL.drawingBufferHeight, this.contextWebGL.RGBA, this.contextWebGL.UNSIGNED_BYTE, imageData); // Detect incorrect GPU accelerated WebGL image processing by checking for incorrect alpha channel data

	          if (imageData[3] !== 255) {
	            console.warn("Detected incorrect GPU accelerated WebGL image processing, switching to canvas mode");
	    ...
	    value: function setupContext(canvas) {
	      ...
	      var force2d = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
	    ...
	    value: function setupCameraUploadGuiAssets() {
	      ...
	      assign(this.cameraUploadElement.style, defaultSettings.containerStyle, this.singleImageModeSettings.containerStyle);
	      ...
	      assign(informationElement.style, defaultSettings.informationStyle, this.singleImageModeSettings.informationStyle);
	      ...
	      [this.cameraUploadProgressElement.style, cameraUploadButtonIconElement.style].forEach(function (style) {
	        assign(style, defaultSettings.buttonStyle, _this3.singleImageModeSettings.buttonStyle);
	      });
	    ...
	    value: function () {
	      var _checkAndRecoverPlayback = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	    ...
	    value: function () {
	      var _cameraUploadImageLoad = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(image) {
	    ...
	    value: function () {
	      var _cameraUploadFileProcess = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(image, width, height) {
	        return regenerator.wrap(function _callee3$(_context3) {
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              case 0:
	    ...
	    value: function () {
	      var _cameraSwitcherListener = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(event) {
	    ...
	    value: function setupTorchToggler() {
	      ...
	      ["touchstart", "mousedown"].forEach(function (eventName) {
	        _this6.torchTogglerElement.addEventListener(eventName, /*#__PURE__*/function () {
	          var _ref = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(event) {
	            return regenerator.wrap(function _callee5$(_context5) {
	              while (1) {
	                switch (_context5.prev = _context5.next) {
	                  case 0:
	...
	_defineProperty(GUI, "grandParentElementClassName", "scandit scandit-container");

	_defineProperty(GUI, "parentElementClassName", "scandit scandit-barcode-picker");

	_defineProperty(GUI, "hiddenClassName", "scandit-hidden");

	_defineProperty(GUI, "hiddenOpacityClassName", "scandit-hidden-opacity");

	_defineProperty(GUI, "videoElementClassName", "scandit-video");

	_defineProperty(GUI, "scanditLogoImageElementClassName", "scandit-logo");

	_defineProperty(GUI, "laserContainerElementClassName", "scandit-laser");

	_defineProperty(GUI, "viewfinderElementClassName", "scandit-viewfinder");

	_defineProperty(GUI, "cameraSwitcherElementClassName", "scandit-camera-switcher");

	_defineProperty(GUI, "torchTogglerElementClassName", "scandit-torch-toggle");

	_defineProperty(GUI, "cameraUploadElementClassName", "scandit-camera-upload");

	_defineProperty(GUI, "flashColorClassName", "scandit-flash-color");

	_defineProperty(GUI, "flashWhiteClassName", "scandit-flash-white");

	_defineProperty(GUI, "flashInsetClassName", "scandit-flash-inset");

	_defineProperty(GUI, "opacityPulseClassName", "scandit-opacity-pulse");

	_defineProperty(GUI, "mirroredClassName", "mirrored");

	_defineProperty(GUI, "pausedClassName", "paused");
	...
	exports.BarcodePicker = /*#__PURE__*/function () {
	  function BarcodePicker(originElement, _ref) {
	    ...
	    _defineProperty(this, "beepSound", void 0);

	    _defineProperty(this, "vibrateFunction", void 0);

	    _defineProperty(this, "scannerReadyEventListener", void 0);

	    _defineProperty(this, "playSoundOnScan", void 0);

	    _defineProperty(this, "vibrateOnScan", void 0);

	    _defineProperty(this, "scanningPaused", void 0);

	    _defineProperty(this, "fatalError", void 0);

	    _defineProperty(this, "latestVideoTimeProcessed", void 0);

	    _defineProperty(this, "destroyed", void 0);

	    _defineProperty(this, "isReadyToWork", void 0);

	    _defineProperty(this, "cameraAccess", void 0);

	    _defineProperty(this, "targetScanningFPS", void 0);

	    _defineProperty(this, "averageProcessingTime", void 0);

	    _defineProperty(this, "externalImageData", void 0);

	    _defineProperty(this, "internalImageData", void 0);
	  ...
	  _createClass(BarcodePicker, [{
	    ...
	    key: "resumeScanning",
	    value: function () {
	      var _resumeScanning = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	    ...
	    key: "setActiveCamera",
	    value: function () {
	      var _setActiveCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2(camera, cameraSettings) {
	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	    ...
	    key: "setCameraType",
	    value: function () {
	      var _setCameraType = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3(cameraType) {
	        return regenerator.wrap(function _callee3$(_context3) {
	          while (1) {
	            switch (_context3.prev = _context3.next) {
	              case 0:
	    ...
	    key: "applyCameraSettings",
	    value: function () {
	      var _applyCameraSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4(cameraSettings) {
	        return regenerator.wrap(function _callee4$(_context4) {
	          while (1) {
	            switch (_context4.prev = _context4.next) {
	              case 0:
	    ...
	    key: "setTorchEnabled",
	    value: function () {
	      var _setTorchEnabled = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee5(enabled) {
	        return regenerator.wrap(function _callee5$(_context5) {
	          while (1) {
	            switch (_context5.prev = _context5.next) {
	              case 0:
	    ...
	    key: "setZoom",
	    value: function () {
	      var _setZoom = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(zoomPercentage) {
	        return regenerator.wrap(function _callee6$(_context6) {
	          while (1) {
	            switch (_context6.prev = _context6.next) {
	              case 0:
	    ...
	    key: "accessCamera",
	    value: function () {
	      var _accessCamera = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee7() {
	        return regenerator.wrap(function _callee7$(_context7) {
	          while (1) {
	            switch (_context7.prev = _context7.next) {
	              case 0:
	    ...
	    value: function scheduleVideoProcessing() {
	      ...
	      window.setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee8() {
	        return regenerator.wrap(function _callee8$(_context8) {
	          while (1) {
	            switch (_context8.prev = _context8.next) {
	              case 0:
	    ...
	    value: function () {
	      var _scheduleNextVideoProcessing = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee9(processingStartTime) {
	    ...
	    value: function () {
	      var _processVideoFrame = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee10(highQualitySingleFrameMode) {
	        var scanResult;
	        return regenerator.wrap(function _callee10$(_context10) {
	          while (1) {
	            switch (_context10.prev = _context10.next) {
	    ...
	    key: "videoProcessing",
	    value: function () {
	      var _videoProcessing = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee11() {
	     ...
	     * frame, independently from the number of recognized barcodes (can be none). The returned barcodes are affected by
	     * [[ScanSettings]]'s *codeDuplicateFilter* option.
	     *
	     * @asMemberOf BarcodePicker
	     * @event
	     * @param scanResult The result of the scanning operation on the image.
	    ...
	    key: "create",
	    value: function () {
	      var _create = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee12(originElement) {
	        var _ref6;
	...
	var attributes = values(Attribute);
	...
	var _Attribute$ACCESS_CAM, _Attribute$CAMERA, _Attribute$CAMERA_SET, _Attribute$CAMERA_TYP, _Attribute$CONFIGURE, _Attribute$ENABLE_CAM, _Attribute$ENABLE_PIN, _Attribute$ENABLE_TAP, _Attribute$ENABLE_TOR, _Attribute$GUI_STYLE, _Attribute$LASER_AREA, _Attribute$PLAY_SOUND, _Attribute$SCANNING_P, _Attribute$SINGLE_IMA, _Attribute$TARGET_SCA, _Attribute$VIBRATE_ON, _Attribute$VIDEO_FIT, _Attribute$VIEWFINDER, _Attribute$VISIBLE, _Attribute$CONFIGURE_, _Attribute$CONFIGURE_2, _Attribute$CONFIGURE_3, _Attribute$CONFIGURE_4, _Attribute$CONFIGURE_5, _Attribute$SCAN_SETTI, _Attribute$SCAN_SETTI2, _Attribute$SCAN_SETTI3, _Attribute$SCAN_SETTI4, _Attribute$SCAN_SETTI5, _Attribute$SCAN_SETTI6, _Attribute$SCAN_SETTI7, _Attribute$SCAN_SETTI8;
	_Attribute$ACCESS_CAM = Attribute.ACCESS_CAMERA;
	_Attribute$CAMERA = Attribute.CAMERA;
	_Attribute$CAMERA_SET = Attribute.CAMERA_SETTINGS;
	_Attribute$CAMERA_TYP = Attribute.CAMERA_TYPE;
	_Attribute$CONFIGURE = Attribute.CONFIGURE;
	_Attribute$ENABLE_CAM = Attribute.ENABLE_CAMERA_SWITCHER;
	_Attribute$ENABLE_PIN = Attribute.ENABLE_PINCH_TO_ZOOM;
	_Attribute$ENABLE_TAP = Attribute.ENABLE_TAP_TO_FOCUS;
	_Attribute$ENABLE_TOR = Attribute.ENABLE_TORCH_TOGGLE;
	_Attribute$GUI_STYLE = Attribute.GUI_STYLE;
	_Attribute$LASER_AREA = Attribute.LASER_AREA;
	_Attribute$PLAY_SOUND = Attribute.PLAY_SOUND_ON_SCAN;
	_Attribute$SCANNING_P = Attribute.SCANNING_PAUSED;
	_Attribute$SINGLE_IMA = Attribute.SINGLE_IMAGE_MODE_SETTINGS;
	_Attribute$TARGET_SCA = Attribute.TARGET_SCANNING_FPS;
	_Attribute$VIBRATE_ON = Attribute.VIBRATE_ON_SCAN;
	_Attribute$VIDEO_FIT = Attribute.VIDEO_FIT;
	_Attribute$VIEWFINDER = Attribute.VIEWFINDER_AREA;
	_Attribute$VISIBLE = Attribute.VISIBLE;
	_Attribute$CONFIGURE_ = Attribute.CONFIGURE_ENGINE_LOCATION;
	_Attribute$CONFIGURE_2 = Attribute.CONFIGURE_LICENSE_KEY;
	_Attribute$CONFIGURE_3 = Attribute.CONFIGURE_PRELOAD_ENGINE;
	_Attribute$CONFIGURE_4 = Attribute.CONFIGURE_HIGH_QUALITY_BLURRY_RECOGNITION;
	_Attribute$CONFIGURE_5 = Attribute.CONFIGURE_PRELOAD_BLURRY_RECOGNITION;
	_Attribute$SCAN_SETTI = Attribute.SCAN_SETTINGS_BLURRY_RECOGNITION;
	_Attribute$SCAN_SETTI2 = Attribute.SCAN_SETTINGS_CODE_DIRECTION_HINT;
	_Attribute$SCAN_SETTI3 = Attribute.SCAN_SETTINGS_CODE_DUPLICATE_FILTER;
	_Attribute$SCAN_SETTI4 = Attribute.SCAN_SETTINGS_DEVICE_NAME;
	_Attribute$SCAN_SETTI5 = Attribute.SCAN_SETTINGS_ENABLED_SYMBOLOGIES;
	_Attribute$SCAN_SETTI6 = Attribute.SCAN_SETTINGS_GPU_ACCELERATION;
	_Attribute$SCAN_SETTI7 = Attribute.SCAN_SETTINGS_MAX_NUMBER_OF_CODES_PER_FRAME;
	_Attribute$SCAN_SETTI8 = Attribute.SCAN_SETTINGS_SEARCH_AREA;
	var LazyAttributeConverter = /*#__PURE__*/function () {
	  function LazyAttributeConverter(schema, view) {
	    _classCallCheck(this, LazyAttributeConverter);
	  ...
	  _createClass(LazyAttributeConverter, [{
	    ...
	    value: function convertToPrimary(attribute) {
	      var _this$view$getAttribu;

	      return convertAttribute(this.schema[attribute], (_this$view$getAttribu = this.view.getAttribute(attribute)) !== null && _this$view$getAttribu !== void 0 ? _this$view$getAttribu : undefined);
	    }
	  }]);
	...
	***************************************************************************** */
	...
	var Validator = /*#__PURE__*/function () {
	  ...
	  _createClass(Validator, null, [{
	    ...
	    value: function isValidCameraType(value) {
	      return values(exports.Camera.Type).includes(value);
	    }
	  }, {
	    key: "isValidGuiStyle",
	    value: function isValidGuiStyle(value) {
	      return values(exports.BarcodePicker.GuiStyle).includes(value);
	    }
	  }, {
	    key: "isValidVideoFit",
	    value: function isValidVideoFit(value) {
	      return values(exports.BarcodePicker.ObjectFit).includes(value);
	    }
	  }, {
	    key: "isValidCodeDirection",
	    value: function isValidCodeDirection(value) {
	      return values(exports.ScanSettings.CodeDirection).includes(value);
	    }
	  }, {
	    key: "isArray",
	    ...
	    value: function getExpectationMessageForType(type) {
	      var messageByType = {
	        ...
	        videoFit: "Expected one of \"".concat(values(exports.BarcodePicker.ObjectFit).join('", "'), "\""),
	        ...
	        cameraType: "Expected one of \"".concat(values(exports.Camera.Type).join('", "'), "\""),
	        codeDirection: "Expected one of \"".concat(values(exports.ScanSettings.CodeDirection).join('", "'), "\""),
	        guiStyle: "Expected one of \"".concat(values(exports.BarcodePicker.GuiStyle).join('", "'), "\""),
	...
	_defineProperty(Validator, "expectationMessage", new map());
	...
	function ownKeys(object, enumerableOnly) { var keys = Object.keys(object); if (getOwnPropertySymbols) { var symbols = getOwnPropertySymbols(object); if (enumerableOnly) { symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; }); } keys.push.apply(keys, symbols); } return keys; }

	function _objectSpread(target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i] != null ? arguments[i] : {}; if (i % 2) { ownKeys(Object(source), true).forEach(function (key) { _defineProperty(target, key, source[key]); }); } else if (getOwnPropertyDescriptors) { Object.defineProperties(target, getOwnPropertyDescriptors(source)); } else { ownKeys(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } } return target; }
	var Controller = /*#__PURE__*/function () {
	  function Controller(view) {
	    ...
	    _defineProperty(this, "lazyAttributeConverter", void 0);

	    _defineProperty(this, "scanSettings", void 0);

	    _defineProperty(this, "viewConnected", false);

	    _defineProperty(this, "trackAttributes", true);

	    _defineProperty(this, "allSymbologies", values(exports.Barcode.Symbology).filter(function (s) {
	  ...
	  _createClass(Controller, [{
	    ...
	    value: function () {
	      var _viewConnectedCallback = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	    ...
	    key: "initPicker",
	    value: function () {
	      var _initPicker = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee2() {
	        return regenerator.wrap(function _callee2$(_context2) {
	          while (1) {
	            switch (_context2.prev = _context2.next) {
	              case 0:
	    ...
	    value: function onScannerNewScanSettings(scanSettings) {
	      ...
	      var allSymbologies = values(exports.Barcode.Symbology).filter(function (s) {
	        return typeof s === "string";
	      }); // tslint:disable-next-line: no-any
	      ...
	      changeSet.forEach(function (change) {
	        _this3.onPickerPropertyUpdate(_objectSpread({
	          origin: "scanner"
	        }, change));
	      });
	    }
	    ...
	    value: function () {
	      var _getCameraFromAttribute = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee3() {
	    ...
	    value: function () {
	      var _getSingleImageModeSettings = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee4() {
	        var _this6 = this;
	            ...
	            switch (_context4.prev = _context4.next) {
	              case 0:
	                ...
	                if (this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS] != null) {
	                  ...
	                  settings.desktop = _objectSpread(_objectSpread({}, exports.SingleImageModeSettings.defaultDesktop), (_this$lazyAttributeCo = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].desktop) !== null && _this$lazyAttributeCo !== void 0 ? _this$lazyAttributeCo : {});
	                  settings.mobile = _objectSpread(_objectSpread({}, exports.SingleImageModeSettings.defaultMobile), (_this$lazyAttributeCo2 = this.lazyAttributeConverter[Attribute.SINGLE_IMAGE_MODE_SETTINGS].mobile) !== null && _this$lazyAttributeCo2 !== void 0 ? _this$lazyAttributeCo2 : {});
	...
	var ScanditBarcodePicker = /*#__PURE__*/function (_HTMLElement) {
	  _inherits(ScanditBarcodePicker, _HTMLElement);

	  var _super = _createSuper(ScanditBarcodePicker);

	  function ScanditBarcodePicker() {
	    var _this;

	    _classCallCheck(this, ScanditBarcodePicker);

	    _this = _super.call(this);

	    _defineProperty(_assertThisInitialized(_this), "shadowDom", void 0);
	  ...
	  _createClass(ScanditBarcodePicker, [{
	    key: "barcodePicker",
	    get:
	    /**
	    ...
	    value: function () {
	      var _connectedCallback = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
	        return regenerator.wrap(function _callee$(_context) {
	          while (1) {
	            switch (_context.prev = _context.next) {
	              case 0:
	...
	_defineProperty(ScanditBarcodePicker, "TAG_NAME", "scandit-barcode-picker");
	...
	exports.scanditDataCaptureLocation = void 0;
	/**
	 * @hidden
	 */
	...
	exports.highEndBlurryRecognition = void 0;
	/**
	 * @hidden
	 */
	...
	function configure(licenseKey) {
	  var _ref = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {},
	      ...
	      _ref$highQualityBlurr = _ref.highQualityBlurryRecognition,
	      highQualityBlurryRecognition = _ref$highQualityBlurr === void 0 ? false : _ref$highQualityBlurr,
	  ...
	  exports.configurePromise = new promise( /*#__PURE__*/function () {
	    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
	      var browserCompatibility, browserName, osName, indexedDBStatusCheckInterval;
	      return regenerator.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	            ...
	            case 7:
	              ...
	              browserName = exports.BrowserHelper.userAgentInfo.getBrowser().name;
	              osName = exports.BrowserHelper.userAgentInfo.getOS().name;

	              if (!((browserName == null || browserName.includes("Safari") || osName == null || osName === "iOS") && window.indexedDB != null && "databases" in indexedDB)) {
	                _context.next = 15;
	                break;
	              }

	              _context.next = 15;
	              return new promise(function (resolveCheck) {
	                ...
	                return clearInterval(indexedDBStatusCheckInterval);
	              });
	            ...
	            case 21:
	              exports.dataCaptureLoader = new DataCaptureLoader(preloadEngine);
	...
	exports.dataCaptureWorkerBlob = dataCaptureWorkerBlob;
