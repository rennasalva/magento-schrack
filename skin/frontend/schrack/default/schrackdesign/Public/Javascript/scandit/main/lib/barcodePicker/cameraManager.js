...
var CameraManager = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                if (this.mediaStream != null) {
                    ...
                    return [2 /*return*/, new Promise(function (resolve) {
                            setTimeout(function () {
                                var _a;
                                (_a = _this.mediaStream) === null || _a === void 0 ? void 0 : _a.getVideoTracks().forEach(function (track) {
    ...
    CameraManager.prototype.initializeCamera = function (camera, cameraResolutionConstraint) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var stream, mediaTrackSettings, browserName_1, error_3, error_4;
            var _this = this;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.stopStream()];
                    case 1:
                        _a.sent();
                    ...
                    case 3:
                        ...
                        browserName_1 = browserHelper_1.BrowserHelper.userAgentInfo.getBrowser().name;
                        this.mediaStream.getVideoTracks().forEach(function (track) {
                            // Handle unexpected stream end events
                            track.addEventListener("ended", _this.videoTrackEndedListener);
                            if (browserName_1 != null && browserName_1.includes("Safari")) {
        ...
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (_, reject) {
                        _this.cameraAccessTimeout = window.setTimeout(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                            return tslib_1.__generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
            ...
            return tslib_1.__generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.gui.videoElement.onloadeddata = function () {
                            ...
                            _this.videoMetadataCheckInterval = window.setInterval(function () { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                                return tslib_1.__generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            if (!(this.gui.videoElement.videoWidth <= 2 ||
                                                this.gui.videoElement.videoHeight <= 2 ||
                                                this.gui.videoElement.currentTime === 0)) return [3 /*break*/, 3];
                                            if (!(performance.now() - videoMetadataCheckStartTime > CameraManager.videoMetadataCheckTimeoutMs)) return [3 /*break*/, 2];
                                            console.debug("Camera video stream access failure (valid video metadata timeout):", camera);
                                            window.clearInterval(this.videoMetadataCheckInterval);
                                            return [4 /*yield*/, this.stopStream()];
                                        case 1:
                                            _a.sent();
                                            return [2 /*return*/, reject(new customError_1.CustomError(CameraManager.notReadableErrorParameters))];
                                        case 2: return [2 /*return*/];
                                        case 3:
                                            window.clearInterval(this.videoMetadataCheckInterval);
