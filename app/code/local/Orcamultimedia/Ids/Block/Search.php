...
class Orcamultimedia_Ids_Block_Search extends Mage_Core_Block_Template {
    ...
    public function getSearchItems(){
    	...
    	foreach ($this->_productCollection as $item) {
            ...
            if ($item->getProduct() == null) {
                ...
                Mage::log('IDS : Log Entry Point #002 -> WWS-ID = ' . $wwsCustomerId, null, 'ids.log');
                ...
                if(Mage::getStoreConfig('ids/custom/enabled', $storeId))
                    $items['NEW_ITEM-' . strtoupper(Mage::getStoreConfig('ids/custom/name')) . '[' . $index . ']'] = $helper->getFieldValue('custom', $item, 1);
