...
class Mage_Core_Model_Cookie
{
    ...
    public function getLifetime()
    {
        if (!is_null($this->_lifetime)) {
            ...
            // Schrack default, if user wants to keep logged in:
            if (Mage::getModel('core/cookie')->get('remembermetrigger') == 'enabled') {
                $lifetime = intval(Mage::getStoreConfig( 'web/cookie/keep_me_logged_in_cookie_lifetime', $this->getStore()));
            }
        }
