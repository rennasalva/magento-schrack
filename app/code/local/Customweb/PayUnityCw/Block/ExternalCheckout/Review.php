...
class Customweb_PayUnityCw_Block_ExternalCheckout_Review extends Mage_Sales_Block_Items_Abstract
{
	private $_context;
	...
	public function isAdditionalInformationRequired()
	{
		return Mage::helper('PayUnityCw/externalCheckout')->isGenderRequired($this->getQuote())
			|| 	Mage::helper('PayUnityCw/externalCheckout')->isDateOfBirthRequired($this->getQuote());
	}
