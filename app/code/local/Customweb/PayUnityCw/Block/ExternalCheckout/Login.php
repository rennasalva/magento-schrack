...
class Customweb_PayUnityCw_Block_ExternalCheckout_Login extends Mage_Core_Block_Template
{
	private $_context;
	...
	{
		parent::_construct();
		$this->setTemplate('customweb/payunitycw/external_checkout/login.phtml');
	}
	...
	{
		return Mage::getUrl('PayUnityCw/Externalcheckout/loginPost', array('_secure'=>true));
	}
	
	public function getRegisterPostAction()
	{
		return Mage::getUrl('PayUnityCw/Externalcheckout/registerPost', array('_secure'=>true));
	}
