...
class Customweb_PayUnityCw_Block_ExternalCheckout_ShippingMethods extends Mage_Core_Block_Template
{
	private $_context;
	...
	{
		parent::_construct();
		$this->setTemplate('customweb/payunitycw/external_checkout/shipping-methods.phtml');
	}
