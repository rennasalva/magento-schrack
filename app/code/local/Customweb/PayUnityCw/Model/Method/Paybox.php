...
class Customweb_PayUnityCw_Model_Method_Paybox extends Customweb_PayUnityCw_Model_Method
{
	protected $_code = 'payunitycw_paybox';
	protected $paymentMethodName = 'paybox';
