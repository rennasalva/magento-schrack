...
class Customweb_PayUnityCw_Model_Method_KlarnaInstallments extends Customweb_PayUnityCw_Model_Method
{
	protected $_code = 'payunitycw_klarnainstallments';
	protected $paymentMethodName = 'klarnainstallments';
