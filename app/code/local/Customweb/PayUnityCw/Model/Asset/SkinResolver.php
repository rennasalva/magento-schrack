...
class Customweb_PayUnityCw_Model_Asset_SkinResolver implements Customweb_Asset_IResolver
{
	...
	private function getSkinFilePath($identifier) {
		return Mage::getSingleton('core/design_package')->getFilename('customweb/payunitycw/assets/' . $identifier, array(
			'_type' => 'skin'
		));
	}
	
	private function getSkinUrl($identifier) {
		return Mage::getSingleton('core/design_package')->getSkinUrl('customweb/payunitycw/assets/' . $identifier);
	}
}