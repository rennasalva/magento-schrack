 ...
 * @Bean
 */
class Customweb_PayUnityCw_Model_UpdateHandler implements Customweb_Payment_Update_IHandler
{
	public function getContainer() {
		return Mage::helper('PayUnityCw')->createContainer();
	}
	...
	public function log($message, $type) {
		...
		Mage::helper('PayUnityCw')->log($message, $level);
	}

	public function getScheduledTransactionIds() {
		$resource = Mage::getSingleton('core/resource');
		$readConnection = $resource->getConnection('core_read');
		$query = 'SELECT transaction_id FROM ' . $resource->getTableName('payunitycw/transaction')
