...
class Customweb_PayUnityCw_Model_Api2_Transaction_Rest extends Customweb_PayUnityCw_Model_Api2_Transaction
{
	...
	{
		$transaction = Mage::getModel('payunitycw/transaction')->load($id);
	...
	protected function prepareEntry(Customweb_PayUnityCw_Model_Transaction $transaction)
	{
