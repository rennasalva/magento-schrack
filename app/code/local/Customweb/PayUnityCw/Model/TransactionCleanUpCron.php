 ...
 */
class Customweb_PayUnityCw_Model_TransactionCleanUpCron {
	...
	public function cleanUp() {
		...
		$failedCollection = Mage::getModel('payunitycw/transaction')->getCollection()
		...
		$pendingCollection = Mage::getModel('payunitycw/transaction')->getCollection()
		...
		$noStatusCollection = Mage::getModel('payunitycw/transaction')->getCollection()
