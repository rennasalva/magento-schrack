...
class Customweb_PayUnityCw_Model_Transaction_Api extends Mage_Api_Model_Resource_Abstract
{
    ...
    protected function prepareEntry(Customweb_PayUnityCw_Model_Transaction $transaction, $attributes = null)
    {
    	...
    	if (is_string($transaction->getTransactionObject())) {
    		$transaction->setTransactionObject(Mage::helper('PayUnityCw')->unserialize($transaction->getTransactionObject()));
    	}
