...
class Customweb_PayUnityCw_MotopayunitycwController extends Mage_Adminhtml_Controller_Action
{

	protected function _isAllowed()
	{
		return Mage::getSingleton('admin/session')->isAllowed('sales/payunitycw/payunitycw_moto');
	}
	...
	public function processAction()
	{
		...
		$this->getLayout()
			->getBlock('head')
			->addCss('css/payunitycw.css')
			->addJs('customweb/payunitycw/moto.js');
		$this->getLayout()
			->getBlock('content')
			->append($this->getLayout()
				->createBlock('payunitycw/moto'));
