 ...
 * 
 */
class Customweb_PayUnityCw_ConfigpayunitycwController extends Mage_Adminhtml_Controller_Action {

	protected function _isAllowed(){
		return Mage::getSingleton('admin/session')->isAllowed('system/payunitycw');
	}
	...
	public function indexAction(){
		...
		if (!empty($forms)){
			...
			$this->_title('PayUnity');
			
			$this->_setActiveMenu('system/payunitycw');
	...
	public function viewAction(){
		...
		if (!empty($machineName)) {
			...
			$this->_addContent($this->getLayout()->createBlock('payunitycw/adminhtml_backendForm_form')->setForm($form));
		}
	...
	private function updateStoreHierarchy(){
		...
		Customweb_PayUnityCw_Model_ConfigurationAdapter::setStoreHierarchy($storeHierarchy);
	}
