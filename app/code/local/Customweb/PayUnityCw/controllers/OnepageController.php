 ...
 *
 */
class Customweb_PayUnityCw_OnepageController extends Mage_Checkout_Controller_Action {

	/**
	 *
	 * @return Customweb_PayUnityCw_OnepageController
	 */
	...
	protected function _getPaymentMethodsHtml(){
		...
		foreach($layout->getAllBlocks() as $block){
			if($block instanceof Customweb_PayUnityCw_Block_Form){
