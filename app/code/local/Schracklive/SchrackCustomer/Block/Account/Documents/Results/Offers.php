...
class Schracklive_SchrackCustomer_Block_Account_Documents_Results_Offers extends Schracklive_SchrackCustomer_Block_Account_Documents_Results {
    ...
    /**
     * @Override
     * @return Mage_Sales_Model_Mysql4_Invoice_Collection
     */
    public function getDocuments() {
        $searchRequest = $this->_getSearchRequest('type_offers');       
