...
class Schracklive_SchrackCustomer_Block_Account_Documents_Results_Shipments extends Schracklive_SchrackCustomer_Block_Account_Documents_Results {

    /**
     * @Override
     * @return Mage_Sales_Model_Mysql4_Shipment_Collection
     */
    public function getDocuments() {
        $searchRequest = $this->_getSearchRequest('type_deliveries');
    ...
    protected function getDocumentNumberFieldDescription() {
        return $this->__('Shipment Number');
    }
