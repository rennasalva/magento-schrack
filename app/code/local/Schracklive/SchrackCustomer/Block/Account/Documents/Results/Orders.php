...
class Schracklive_SchrackCustomer_Block_Account_Documents_Results_Orders extends Schracklive_SchrackCustomer_Block_Account_Documents_Results {
    ...
    public function getDocuments() {        
        $searchRequest = $this->_getSearchRequest('type_orders');              
