...
class Schracklive_SchrackCustomer_Block_Account_Documents_Results_Creditmemos extends Schracklive_SchrackCustomer_Block_Account_Documents_Results {

    /**
     * @Override
     * @return Mage_Sales_Model_Mysql4_Credit_Collection
     */
    public function getDocuments() {
        $searchRequest = $this->_getSearchRequest('type_creditmemos');
    ...
    protected function getDocumentNumberFieldDescription() {
        return $this->__('Credit Memo Number');
    }
}
